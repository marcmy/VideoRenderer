...
try {
    ...
    foreach ($fileName in $targets.Keys) {
        ...
        $destination = $targets[$fileName]
        Write-Host "Installing SVP4 grid24 TEST $fileName..."
    ...
    Write-Host
    Write-Host 'MPCVR SVP4 grid24 TEST installed successfully.' -ForegroundColor Green
    ...
    Write-Host
    Write-Host "SVP4 grid24 test installer failed: $($_.Exception.Message)" -ForegroundColor Red
    Finish 1
}
