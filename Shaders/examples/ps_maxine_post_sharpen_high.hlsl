...
//
// High strength: intentionally obvious for A/B testing. This may exaggerate
// compression texture or edge halos on difficult material.

Texture2D<float4> tex : register(t0);
SamplerState samp : register(s0);

static const float SHARPNESS = 0.70;
