...
//
// Low strength: intended to restore a small amount of perceived detail
// without making compression noise or halos prominent.

Texture2D<float4> tex : register(t0);
SamplerState samp : register(s0);

static const float SHARPNESS = 0.25;
